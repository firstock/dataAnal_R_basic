getwd()
setwd("D:/gitgub/dataAnal_R_basic")
#openAPI
#고용보험 피보험자
...
url1= "http://openapi.seoul.go.kr:8088/504247774f6f70743430624574717a/xml/octastatapi10453/1/5/"
...
#data frame 만 가능
write_xml(headSJ,"data/seoul_.xml")
